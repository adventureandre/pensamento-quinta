...
export function FavoritosDashboard() {
    ...
    return (
        <section>
            <h2 className="text-3xl font-semibold font-playfair">Favoritos</h2>
            <div className="w-full h-[420px] flex flex-wrap w-full p-3 gap-x-6 mt-5 rounded-3xl">
                {
                    livros.map(livro => (
                        <article className="w-52 h-[370px] flex-col justify-items-center p-5 mt-5 rounded-3xl"
                            ...
                            <FaHeart className="justify-self-end" />
